...
import com.riskeys.quartz.quartz.QuartzFactory;
import com.riskeys.quartz.service.QuartzService;
...
//        List<ScheduleJob> scheduleJobs = jobService.list();
        ...
        Collection<ScheduleJob> scheduleJobs = jobService.listByMap(columnMap);
