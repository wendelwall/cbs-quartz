package com.riskeys.quartz.service.impl;

import com.riskeys.quartz.config.FeignClientsConfiguration;
import com.riskeys.quartz.service.FeignService;
import feign.*;
...
public class FeignServiceImpl implements FeignService {
    ...
    public FeignServiceImpl(Decoder decoder, Encoder encoder, Client client, Contract contract,
        ...
        feign.Logger logger = loggerFactory.create(this.getClass());//必须构建，否则日志中无法看到重试的次数
